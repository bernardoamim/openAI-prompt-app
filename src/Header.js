							...
							<Textarea readOnly name="copy-textarea" id="copy-textarea" value={this.props.store.copyToClipboardText}  />
							 <HeaderExpand>
										<Body className="px-4 py-4 md:px-28 md:py-8 lg:py-12 flex items-center flex-1">
											...
											<div>
												<div className="hidden md:block text-4xl text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-500 inline-block">Da ficção científica à <span className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-fill-transparent bg-clip-text'>realidade</span></div>
												<div className="flex">
...
const Logo = () => (
	<img className='h-16 mr-4' alt='logo' src='https://assets.website-files.com/63d60d2eabaf2e0f5f753e3c/63d60d2eabaf2e36da753e7d_Logo.svg' />
)
